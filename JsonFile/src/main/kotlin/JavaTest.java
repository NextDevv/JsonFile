...
public class JavaTest {
    public static void main(String[] args) {
        ...
        JsonFile file = new JsonFile("C:\\Users\\ciaoc\\OneDrive\\Desktop\\JsonFile\\src\\main\\resources", "JavaConfig");
        if(!file.exists()) file.create();

        file.set("Person", new Person("John.Doe@example.com","John Doe", "new York City"));

        Person person = (Person) file.getObject("Person", Person.class);
